...
export const COMPARE_SECTIONS: CompareSection[] = [
  ...
  },
  {
    ...
    icon: '⚡',
    fields: [
      { key: 'potenciaMaxEV', label: 'Potencia Máxima (EV)', unit: 'HP', better: 'higher', category: 'powertrain' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'potenciaMaxMotorTermico', label: 'Potencia máx. (motor térmico)', unit: 'HP', better: 'higher', category: 'powertrain' },
      { key: 'potenciaMaxSistemaHibrido', label: 'Potencia máx. (sistema híbrido)', unit: 'HP', better: 'higher', category: 'powertrain' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'modosConduccion', label: 'Modos de conducción', better: 'boolean', category: 'comfort' },
      { key: 'octanajeRecomendado', label: 'Octanaje recomendado', unit: 'RON', better: 'boolean', category: 'powertrain' },
      { key: 'potenciaMaxMotorTermico', label: 'Potencia máx.', unit: 'HP', better: 'higher', category: 'powertrain' },
